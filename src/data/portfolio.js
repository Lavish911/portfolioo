...
export const PROJECTS = [
  {
    ...
    desc: 'A live assistant that listens to technical interviews and surfaces structured answers before the silence gets awkward.',
    problem: 'Candidates struggle to practice realistic interviews with immediate, contextual feedback.',
    solution: 'Built a WebSocket-powered platform that listens to live interviews, generates AI questions, and streams low-latency conversational assistance.',
  ...
  },
  {
    ...
    desc: 'Reads emotion from the camera and personality from writing to recommend content that fits the moment, not the average.',
    problem: 'Generic recommendations ignore emotional and personality context, feeling impersonal and poorly timed.',
    solution: 'Fused DeepFace computer vision and BERT-based NLP into a single human-centred ranking that adapts to how you feel and think.',
  ...
  },
  {
    ...
    desc: 'Turns fragmented stroke-unit data — imaging, labs, handwritten notes — into a single risk picture clinicians can act on in seconds.',
    problem: 'Stroke-unit data is fragmented across imaging, labs and handwritten notes, delaying critical risk decisions.',
    ...
    highlights: ['Real-time risk stratification', '90-day recovery forecast', 'Intervention simulation'],
